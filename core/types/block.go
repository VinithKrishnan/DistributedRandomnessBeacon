...
type Header struct {
	...
	Commitments [][96]byte     `json:"commitments"      gencodec:"required"`
	EncEvals    [][48]byte     `json:"encEvals"      gencodec:"required"`
...
func (b *Block) Commitments() [][96]byte { return b.header.Commitments }
func (b *Block) EncEvals() [][48]byte    { return b.header.EncEvals }
...
func (b *Block) UpdateDRB(isets []uint64, commitments [][96]byte, encEvals [][48]byte, root common.Hash) {
